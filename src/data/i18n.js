...
export const I18N = {
  ...
  "exp.date5": { id: "2026", en: "2026" },
  "exp.date6": { id: "2026", en: "2026" },
  "exp.date7": { id: "2026", en: "2026" },
  ...
  "exp.title5": {
    id: "Sub-Divisi Desain Grafis, Divisi Kewirausahaan",
    en: "Graphic Design Sub-Division, Entrepreneurship Division",
  },
  "exp.title6": { id: "Divisi Kesehatan", en: "Health Division" },
  "exp.title7": { id: "Divisi Desain Grafis", en: "Graphic Design Division" },
  ...
  "exp.desc5": {
    id: "Berkontribusi di Sub-Divisi Desain Grafis, mendukung kegiatan kerohanian dan kewirausahaan komunitas mahasiswa Hindu ITS.",
    en: "Contributed to the Graphic Design Sub-Division, supporting the spiritual and entrepreneurship activities of ITS's Hindu student community.",
  },
  "exp.desc6": {
    id: "Turut merencanakan dan menjalankan acara SIMAKRAMA sebagai anggota Divisi Kesehatan.",
    en: "Helped plan and run the SIMAKRAMA event as a member of the Health Division.",
  },
  "exp.desc7": {
    id: "Turut merencanakan dan menjalankan acara GPD sebagai anggota Divisi Desain Grafis.",
    en: "Helped plan and run the GPD event as a member of the Graphic Design Division.",
  },
  ...
  "exp.tag5a": { id: "Desain Grafis", en: "Graphic Design" },
  "exp.tag5b": { id: "Komunitas", en: "Community" },
  "exp.tag6a": { id: "Kesehatan", en: "Health" },
  "exp.tag6b": { id: "Tim Acara", en: "Event Team" },
  "exp.tag7a": { id: "Desain Grafis", en: "Graphic Design" },
  "exp.tag7b": { id: "Tim Acara", en: "Event Team" },
